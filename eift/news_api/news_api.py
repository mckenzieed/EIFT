import requests
from eift.api.models.source import source_response
from eift.api.models.article import article_response
...
def get_news_articles_top_headlines(api_key, country=None, category=None, sources=None, keyword=None, page_size=100,
    ...
    url = build_url_for_top_headlines_query(api_key, country, category, sources, keyword, page_size, page)
...
def get_news_articles_everything(api_key, keyword=None, sources=None, domains=None, date_from=None, date_to=None,
    ...
    # Build the initial url.
    url = build_url_for_everything_query(api_key, keyword, sources, domains, date_from, date_to, language, sort_by, page_size, page)
...
def build_url_for_everything_query(api_key, keyword=None, sources=None, domains=None, date_from=None, date_to=None,
...
def build_url_for_top_headlines_query(api_key, country=None, category=None, sources=None, keyword=None, page_size=None,
                                      page=None):
    """
    Gets all news articles based on the arguments provided.
